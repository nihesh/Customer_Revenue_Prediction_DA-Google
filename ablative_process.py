...
def load_dataset(path):
	...
	DROP = ['pageviews','continent','socialEngagementType', 'hits', 'isMobile', 'browser', 'browserSize', 'browserVersion', 'deviceCategory', 'flashVersion', 'language', 'mobileDeviceBranding', 'mobileDeviceInfo',
